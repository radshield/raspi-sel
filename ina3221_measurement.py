...
def main_loop(ina3221, data_rate, out_file):
    ...
    while run_flag:
        log.write('{},{},{},{},{},{},{},{},{}\n'.format(str(time.time()),
                                                        100.0 - psutil.cpu_percent(percpu=True)[0],
                                                        100.0 - psutil.cpu_percent(percpu=True)[1],
                                                        100.0 - psutil.cpu_percent(percpu=True)[2],
                                                        100.0 - psutil.cpu_percent(percpu=True)[3],
